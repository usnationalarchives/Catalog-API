...
Important: This script does NOT call the National Archives Catalog API, so it will not impact your query limit. It only reads CSVs and downloads URLs.
...
Contact
- For questions about the Catalog API, contact Catalog_API@nara.gov
